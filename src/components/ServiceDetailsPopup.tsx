...
export default function ServiceDetailsPopup({ service, onClose, onBuyNow }: ServiceDetailsPopupProps) {
  ...
  const defaultFAQ = [
    {
      ...
      answer: 'Processing time varies by service. Standard processing typically takes 3-5 business days.'
    },
    {
      question: 'What happens after I purchase?',
      answer: 'You\'ll receive detailed instructions and our team will guide you through the next steps.'
    }
  ];
        ...
        >
          ...
          >
            <div className="p-6 md:p-8">
              ...
              <div className="md:static sticky top-0 bg-white z-10 -mx-6 md:mx-0 px-6 md:px-0 
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      <div className="flex items-baseline gap-1">
                        <span className="text-2xl md:text-3xl font-bold text-[--primary]">
                          ${service.prices[0].unit_amount}
                        </span>
                        <span className="text-gray-500">
                          {service.prices[0].recurring?.interval !== 'one_time' ? `/${service.prices[0].recurring?.interval}` : ''}
                        </span>
                      </div>
                      {service.processingTime && (
                        <div className="flex items-center gap-2 px-3 py-1 bg-blue-50 text-blue-700 
                ...
                <div className="md:col-span-3 space-y-6 md:space-y-8">
                  ...
                  <div>
                    ...
                    <div className="grid gap-4">
                      {(service.features || defaultFeatures).map((feature, index) => (
                        <div 
                          key={index} 
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {(service.requirements || defaultRequirements).map((req, index) => (
                        <div 
                          key={index} 
                ...
                <div className="md:col-span-2 space-y-6">
                  <div className="md:sticky md:top-8">
                    ...
                    <div className="bg-gradient-to-br from-[--primary]/5 to-[--primary]/10 rounded-2xl p-6">
                      ...
                      <div className="space-y-4">
                        {(service.benefits || defaultBenefits).map((benefit, index) => (
                    ...
                    {service.prices.length>0 && (
                      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-100">
                        <h3 className="font-semibold text-blue-900 mb-2">Multiple Plans Available</h3>
                        <p className="text-sm text-blue-700">
                          Choose from different plans tailored to your specific needs. Click "Buy Now" to view and compare all available options.
                        </p>
                      </div>
                    )}
                    ...
                    <div className="bg-gray-50 rounded-2xl p-6">
                      <h3 className="text-lg font-semibold mb-4 text-gray-900">Price Breakdown</h3>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center p-3 bg-white rounded-xl">
                          <span className="text-gray-600">Service Fee</span>
                          <span className="font-medium">${service.prices[0].unit_amount}</span>
                        </div>
                        {Number.parseInt(service.additionalFees!)>1 && (
                          <div className="flex justify-between items-center p-3 bg-amber-50 text-amber-700 rounded-xl">
                            <span>Additional Fees</span>
                            <span>+{service.additionalFees}state fee</span>
                          </div>
                        )}
                        <div className="pt-3 border-t border-gray-200">
                          <div className="flex justify-between items-center p-3 bg-[--primary]/5 rounded-xl">
                            <span className="font-semibold">Total</span>
                            <span className="text-xl font-bold text-[--primary]">${service.prices[0].unit_amount + (Number(service.additionalFees) ?? 0)}</span>
                          </div>
                        </div>
                      </div>
                    </div>
