    ...
    <main className="lg:p-8">
      ...
      <header className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-xl lg:text-2xl font-semibold text-[#333333]">{task.title}</h1>
          ...
          <div className="space-y-6 p-4 lg:p-0">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  <p className="font-medium">{task.assignedCompany.companyName}</p>
                  <p className="text-sm text-gray-500">ID: {task.assignedCompany.id}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">
                    {task.messages.reduce((acc, msg) => acc + msg.attachments.length, 0)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
