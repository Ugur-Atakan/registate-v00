      ...
      <main className="lg:p-8">
              ...
              <div key={user.id} className="p-4">
                ...
                <div className="hidden lg:grid grid-cols-12 gap-4 items-center">
                  <div className="col-span-3 flex items-center gap-2">
                    <Avvvatars value={user.email} style="character" />
                  ...
                  <div className="col-span-3 text-sm">
                    {user.roles.map((role) => (
                      <span
                        key={role}
                        className="px-2 py-1 text-xs bg-[#EEF2FF] text-[#1649FF] rounded-full"
                      >
                        {role}
                      </span>
                    ))}
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between mt-6 gap-4">
          ...
          <div className="flex justify-center space-x-2">
            ...
            <button className="px-4 py-2 bg-[#1649FF] text-white rounded-lg">
              1
            </button>
            <button className="px-4 py-2 bg-white border border-gray-200 rounded-lg hover:bg-gray-50">
              2
