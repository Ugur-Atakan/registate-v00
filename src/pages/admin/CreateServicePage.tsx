...
export default function CreateServicePage({ onBack }: CreateServicePageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await instance.post("/admin/product/create-product", formData);
    } catch (error) {
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      List the features of this service
                    </p>
                  </div>
                  <button
                    type="button"
                      ...
                      >
                        <div className="absolute right-2 top-2 flex items-center space-x-2">
                          ...
                          >
                            ...
                            <span>
                              {price.isDefault ? "Default" : "Make Default"}
                            </span>
                          </button>
                            ...
                            <>
                              <div>
                                ...
                                <select
                                  ...
                                  onChange={(e) =>
                                    handlePriceChange(index, "recurring", {
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    handlePriceChange(index, "recurring", {
                                      interval_count: parseInt(e.target.value),
                                    })
                                  }
                                  className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1649FF]"
                                  min="1"
