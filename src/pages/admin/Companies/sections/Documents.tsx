...
export default function CompanyDocumentsSection({ companyId }: SectionProps) {
  ...
  const filteredDocuments = documents
    .filter((doc) => {
      ...
      const matchesType =
        selectedType === "all" || doc.documentType === selectedType;
  ...
  const handleDeleteCompanyDocument = async (documentId: string) => {
    try {
      await instance.delete(`/admin/company/${documentId}/delete-document`);
                          ...
                          font-medium bg-gray-100 text-gray-800"
                            ...
                            <td className="p-4">
                              ...
                              rounded-lg transition-colors"
                                ...
                                <button
                                  onClick={() => {
                                    handleDeleteCompanyDocument(doc.id);
                                  }}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Upload and manage important company documents here. You can
                view, download, or update documents as needed. Use filters and
                search to quickly find specific documents.
              </p>
            </div>
          </div>
        </div>
